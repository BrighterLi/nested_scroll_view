...
class FQLTab extends StatelessWidget {
...
class _IndicatorPainter extends CustomPainter {
  ...
  final FQTabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == FQTabBarIndicatorSize.label) {
...
class FQLTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [FQLTab] widgets.
  ///
  ...
  /// the indicator with the tab's text for [FQLTab] widgets and all but the
  /// shortest [FQLTab.text] values.
  ///
  ...
  /// is [FQTabBarIndicatorSize.tab] the tab's bounds are as wide as the space
  /// occupied by the tab in the tab bar. If [indicatorSize] is
  /// [FQTabBarIndicatorSize.label], then the tab's bounds are only as wide as
  ...
  /// tab's overall bounds if [indicatorSize] is [FQTabBarIndicatorSize.tab]
  /// (the default) or relative to the bounds of the tab's widget if
  /// [indicatorSize] is [FQTabBarIndicatorSize.label].
  ///
...
class _TabBarState extends State<FQLTabBar> {
  ...
  @override
  void didUpdateWidget(FQLTabBar oldWidget) {
  ...
  void _handleTabControllerAnimationTick() {
    ...
    if (!_controller.indexIsChanging && widget.isScrollable) {
      // Sync the TabBar's scroll position with the FQLTabBarView's PageView.
      _currentIndex = _controller.index;
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller != null) {
      ...
      if (_controller.indexIsChanging) {
        ...
        // The user is dragging the FQLTabBarView's PageView left or right.
...
///
/// To see a sample implementation, visit the [TabController] documentation.
class FQLTabBarView extends StatefulWidget {
...
class _TabBarViewState extends State<FQLTabBarView> {
  TabController _controller;
  ...
  // If the FQLTabBarView is rebuilt with a new tab controller, the caller should
  // dispose the old one. In that case the old controller's animation will be
  // null and should not be accessed.
  bool get _controllerIsValid => _controller?.animation != null;
  ...
  @override
  void didUpdateWidget(FQLTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.controller != oldWidget.controller)
      _updateTabController();
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget _buildTabIndicator(
    ...
    if (tabController.indexIsChanging) {
      ...
      // The selection's offset reflects how far the FQLTabBarView has / been dragged
